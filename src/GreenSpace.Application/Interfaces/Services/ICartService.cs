...
namespace GreenSpace.Application.Interfaces.Services
{
    public interface ICartService
    {
        ...
        Task<IServiceResult<CartDto>> AddItemAsync(Guid userId, ModifyCartItemDto dto);
        Task<IServiceResult<CartDto>> RemoveItemAsync(Guid userId, ModifyCartItemDto dto);
